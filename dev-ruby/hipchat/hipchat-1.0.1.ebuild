...
all_ruby_prepare() {
	...
	sed -i -e '/Coveralls/d' spec/spec_helper.rb || die "sed failed"

	# Replace coveralls with json, GitHub isssue #61
	sed -i -e 's/coveralls/json/' spec/spec_helper.rb || die "sed failed"
}
